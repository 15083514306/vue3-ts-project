...
export const reqAllPermission = () => request.get<any, PermissionResData>(API.ALL_PERMISSION_URL);
...
export const reqRemoveMenu = (id: number) => request.delete<any, BasicResponse>(API.DELETE_MENU_URL + id);
